import type { IPlannerProgramExerciseEvaluatedSet } from "../pages/planner/models/types.ts";
import type { IExerciseType, IProgramSet, ISettings, IWeight } from "../types.ts";
import { Equipment_getUnitOrDefaultForExerciseType } from "./equipment.ts";
import { Weight_evaluateWeight, Weight_rpePct, Weight_roundConvertTo } from "./weight.ts";
