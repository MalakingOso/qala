import type { IProgramState, IProgramExerciseWarmupSet, ISettings, IProgramSet, IPercentage } from "../types.ts";
import { type IEvaluatedProgram, Program_getProgramDayExercises } from "./program.ts";
import {
  ProgramSet_approxTimeMs,
  ProgramSet_isEligibleForInferredWeight,
  ProgramSet_getEvaluatedWeight,
} from "./programSet.ts";
import type { IWeight } from "../types.ts";
import { ObjectUtils_keys, ObjectUtils_values, ObjectUtils_clone } from "../utils/object.ts";
import { Weight_print, Weight_printOrNumber, Weight_isPct, Weight_build, Weight_applyOp, Weight_is } from "./weight.ts";
import { Exercise_onerm } from "./exercise.ts";
import { CollectionUtils_compact, CollectionUtils_sortBy } from "../utils/collection.ts";
import { ScriptRunner } from "../parser.ts";
import type { IAssignmentOp, ILiftoscriptEvaluatorUpdate } from "../liftoscriptEvaluator.ts";
