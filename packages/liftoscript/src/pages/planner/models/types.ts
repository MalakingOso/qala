// IUndoRedoState shape copied from liftosaur `src/pages/builder/utils/undoredo.ts`
// (import rewritten to keep this package free of the app builder).
export interface IUndoRedoState<T> {
  history: { past: T[]; future: T[]; lastHistoryTs?: number };
  current: T;
}
import type { IExerciseKind } from "../../../models/exercise.ts";
import type {
...
import type { IPlannerSyntaxPointer, PlannerSyntaxError } from "../plannerExerciseEvaluator.ts";
