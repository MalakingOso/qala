  ...
  return (
    <div>
      ...
      <Card hero>
        ...
        <p>
          ...
          <span className="kbd-hint">
            Why 10 min today: top set at 87% of reference 1RM.
          </span>
        </p>
      </Card>
        ...
        {RAMP.map((r) => (
          <GroupRow key={r.step}>
            <span>
              ...
              <br />
              <PlateChips plates={platesFor(r.load)} />
            </span>
      ...
      <p className="kbd-hint">
        * coach-practice rule, not a study prescription.
      </p>
    </div>
  );
}
