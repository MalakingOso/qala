    ...
    <div className="page">
      <div className="landing-hero">
        ...
        <div className="row-btns">
          ...
          <SecondaryButton href="#how-it-decides">How it decides</SecondaryButton>
        </div>
      </div>
      <div className="landing-grid">
        ...
        <Card title="Plans">
          <p>Strength, hypertrophy, or meet prep as liftoscript text you can read and edit. Runs live beside the lifts in one week.</p>
        </Card>
        <Card title="Running">
          <p>Time, distance, pace, splits, route with mile markers, audio cues, and guided workouts. Leg fatigue feeds the next lift.</p>
        </Card>
        <Card title="Coach">
          <p>Open conversation inside training topics. Suggestions arrive as engine-vs-coach cards; one tap reverts.</p>
        </Card>
      </div>
      <footer>
        <p className="kbd-hint">
          Qala is AGPL-3.0. Program language and exercise data build on liftosaur (AGPL-3.0).
        </p>
        <p>
          <a className="link-btn" href="#/desktop/programs">Desktop author shell</a>
        </p>
      </footer>
    </div>
  );
